  ...
  <body class="Ts">
    ...
    <div class="align-div-cao">
      <div id="slider-container">
        <div id="image-slider">
          <div class="slide"><img src="swift_dzire_image.png" alt="Image 1" /></div>
          <div class="slide"><img src="swift_interior_image.png" alt="Image 2" /></div>
          <div class="slide"><img src="swift_front.png" alt="Image 3" /></div>
      ...
      <div class="car_info_div">
        <h4 class="car_name_heading">Swift Dzire</h4>
