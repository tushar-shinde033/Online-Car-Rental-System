  ...
  <body class="Ts">
    ...
    <div class="align-div-cao">
      <div id="slider-container">
        <div id="image-slider">
          <div class="slide"><img src="audi_a8_image.png" alt="Image 1" /></div>
          <div class="slide"><img src="audi_a8_front.png" alt="Image 2" /></div>
          <div class="slide"><img src="a8-l-interior-dashboard.png" alt="Image 3" /></div>
      ...
      <div class="car_info_div">
        <h4 class="car_name_heading">AUDI A8</h4>
        <div class="car_info_div_logo_align">
       <div class="home-sci">
        <img src="src/suv.png">
        <p class="car_info_inside_div_para">Sedan</p>
       </div>
       <div class="home-sci">
