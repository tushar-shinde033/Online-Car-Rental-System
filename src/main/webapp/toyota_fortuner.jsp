  ...
  <body class="Ts">
    ...
    <div class="align-div-cao">
      <div id="slider-container">
        <div id="image-slider">
          <div class="slide"><img src="fortuner_legender_images.png" alt="Image 1" /></div>
          <div class="slide"><img src="fortuner_interior.png" alt="Image 2" /></div>
          <div class="slide"><img src="fortuner_front.png" alt="Image 3" /></div>
      ...
      <div class="car_info_div">
        <h4 class="car_name_heading">TOYOTA FORTUNER</h4>
        ...
        <div class="FEATURES_OPTIONS">
          ...
          <div class="features_align">
            ...
            <div class="features_groups3_ground_clearance">
              ...
              <h4 class="features_align_heading4">220 mm</h4>
            </div>
            <div class="features_groups3">
              <img src="src/car_boot.png">
              <p class="features_align_paragraph">Boot Space</p>
              <h4 class="features_align_heading4">296 Litres</h4>
            </div>
            ...
            <div class="features_groups4_engine">
              ...
              <h4 class="features_align_heading4">2.8 L V4</h4>
            </div>
          </div>
